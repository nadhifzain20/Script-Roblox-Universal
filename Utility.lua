...
local ToggleStates = {
	...
	SmartInspector = false -- Ditambahkan untuk Smart Inspector
}
...
UnloadBtn.Activated:Connect(function()
	...
	SetNoclip(false); SetFly(false); SetPotatoMode(false); SetInfJump(false); SetInstantPrompt(false); SetMaxZoom(false); SetAntiAFK(false); SetESP(false); SetSmartInspector(false)
